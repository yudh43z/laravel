...
<div class="content">
    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title">
            <h5><i class="icon-library2 mr-2"></i> <span class="font-weight-semibold">Guru</span> - Data Guru</h5>

            <div class="breadcrumb mt-1">
                <a href="#" class="breadcrumb-item py-0">Data Master</a>
                <span class="breadcrumb-item py-0 active">Guru</span>
            </div>
        </div>
        ...
        <div class="header-elements d-none">
            <div class="d-flex justify-content-center">
                ...
                <a href="{{ route('admin.guru.create') }}" class="btn btn-link btn-float text-default"><i class="icon-file-plus text-primary"></i> <span>Tambah</span></a>
            </div>
        </div>
    </div>
                        ...
                        <table class="table datatable-responsive datatable-scroll-y table-striped" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.guru.edit', [$k]) }}" class="text-warning font-weight-semibold" data-toggle="tooltip" data-placement="left" title="Edit">
                                            <i class="mi-border-color"></i>
                                        </a>
                                        &nbsp;
                                        <form onclick="return confirm('Apakah Anda yakin ingin menghapus data ini? Data yang sudah terhapus tidak dapat dikembalikan');" class="d-inline-block" action="{{ route('admin.guru.destroy', [$k]) }}" method="post">
                                            @csrf
                                            @method('delete')
